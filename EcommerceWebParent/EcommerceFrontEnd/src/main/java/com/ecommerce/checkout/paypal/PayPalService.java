...
public class PayPalService {
	...
	public ResponseEntity<PayPalOrderResponse> makeRequest(String orderId) {
	...
	public void throwExceptionForNonOKResponse(HttpStatus statusCode) throws PayPalApiException {
		String message = null;
		switch(statusCode) {
			case NOT_FOUND:
