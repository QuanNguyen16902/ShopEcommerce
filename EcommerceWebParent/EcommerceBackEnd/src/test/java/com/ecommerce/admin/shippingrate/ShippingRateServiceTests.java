...
import com.ecommerce.admin.shippngrate.ShippingRateNotFoundException;
import com.ecommerce.admin.shippngrate.ShippingRateRepository;
import com.ecommerce.admin.shippngrate.ShippingRateService;
...
public class ShippingRateServiceTests {
	...
	public void testCalculateShippingCost_RateFound() throws ShippingRateNotFoundException {
		...
		Mockito.when(productRepo.findById(countryId)).thenReturn(Optional.of(product));
