...
public class ReportRestControllerTests {
	...
	public void testReportDataLast7Days() throws Exception {
	...
	@Test
	@WithMockUser(username = "user1", password = "pass1", authorities = {"Salesperson"})
	public void testReportDataLast6Months() throws Exception {
	...
	@Test
	@WithMockUser(username = "user1", password = "pass1", authorities = {"Salesperson"})
	public void testReportDataByDateRange() throws Exception {
		String startDate = "2024-03-01";
		String endDate = "2024-03-24";
		String requestURL = "/reports/ssales_by_date/" + startDate + "/" + endDate;
		
		mockMvc.perform(get(requestURL)).andExpect(status().isOk()).andDo(print());
	}
	
	@Test
	@WithMockUser(username = "user2", password = "pass2", authorities = {"Admin"})
