...
function setupButtonEventHandlers(reportType, callbackFunction){
	...
	endDateField = document.getElementById('endDate_date' + reportType);
...
function calculateDays(reportType){
	...
	diffirenceInMilliseconds = endDate - startDate;
	return diffirenceInMilliseconds / MILLISECONDS_A_DAY;
